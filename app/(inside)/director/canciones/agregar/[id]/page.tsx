...
import { createSongsList } from '@/service/backend/director';
...
export default function AgregarCanciones() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSaving(true);
      console.log(songs);
      const response = await createSongsList(serviceId, songs);
      ...
      alert('Error al agregar las canciones');
    } finally {
      setSaving(false);
    }
  };
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <Navbar />
        <div className="p-4">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Agregar Canciones</h1>
    ...
    <div className="min-h-screen bg-gray-50 text-gray-700">
      ...
      <div className="p-4">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Agregar Canciones</h1>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            >
              {saving ? 'Guardando...' : 'Guardar Canciones'}
            </button>
            <button
              type="button"
